  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroDescription}>
            Navigate Metro Manila with ease using AI-powered commuting solutions. 
            Our platform provides predictive routes, calculated fares, and 
            real-time traffic analysis for a smoother, more predictable commute.
          </Text>
        ...
        <View style={styles.purposeContainer}>
          ...
          <Text style={styles.purposeSubtitle}>
            Driven by innovation and a commitment to transform urban mobility in Metro Manila
          </Text>
          ...
          <View style={styles.cardContainer}>
            <View style={styles.purposeCard}>
              ...
              <Text style={styles.cardDescription}>
                To revolutionize urban commuting in Metro Manila by providing intelligent, 
                accessible transportation solutions that reduce travel stress, save time, 
                and empower commuters to make informed travel decisions through cutting-edge 
                AI technology and real-time data analysis.
              </Text>
            </View>
            ...
            <View style={styles.purposeCard}>
              ...
              <Text style={styles.cardDescription}>
                To create a future where commuting in Metro Manila is seamless, predictable, 
                and stress-free. We envision a transportation ecosystem where technology bridges 
                the gap between commuters and public transport, making every journey efficient 
                and enjoyable for all citizens regardless of their destination.
              </Text>
            </View>
          </View>
        </View>
      ...
      <View style={styles.floatButtonsContainer}>
        ...
        <TouchableOpacity
          style={styles.getStartedFloatButton}
          onPress={handleGetStarted}
        >
          <Text style={styles.getStartedFloatButtonText}>Get Started</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    flexGrow: 1,
    paddingBottom: 80, // Space for float buttons
  },
  // Hero Section
  heroSection: {
    padding: 24,
  ...
  floatButtonsContainer: {
    ...
    borderTopWidth: 1,
    borderTopColor: 'rgba(11, 97, 126, 0.1)',
  },
  loginButton: {
    width: '48%',
    paddingVertical: 14,
